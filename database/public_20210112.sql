...
SELECT setval('"public"."aduan_aduan_id_seq"', 22, true);
...
SELECT setval('"public"."aduan_disposisi_aduan_dis_id_seq"', 11, true);
...
SELECT setval('"public"."aduan_history_history_id_seq"', 58, true);
