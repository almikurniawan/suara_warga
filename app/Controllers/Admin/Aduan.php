...
class Aduan extends BaseController
{
    public function index()
    {
        ...
        $data['content_valid']   = $this->gridValid();
        $data['content_invalid']   = $this->gridInValid();
        $data['title']  = 'Aduan';
    ...
    public function gridValid()
    {
        ...
        return $grid->set_query($SQL,[
            ...
            ->configure(
                array(
                    'datasouce_url' => base_url("admin/aduan/gridValid?datasource&" . get_query_string()),
                    'gridReload' => 'gridReloadValid()',
                    'grid_columns'  => array(
                        array(
                            'field' => 'pelapor',
                            'title' => 'Pelapor',
    ...
    public function gridInValid()
    {
        ...
        return $grid->set_query($SQL,[
            ...
            ->configure(
                array(
                    'datasouce_url' => base_url("admin/aduan/gridInValid?datasource&" . get_query_string()),
                    'gridReload' => 'gridReloadValid()',
                    'grid_columns'  => array(
                        array(
                            'field' => 'pelapor',
